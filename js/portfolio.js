  ...
  1: [function (require, module, exports) {
    (function (global) {
      ...
      (function (factory) {
        ...
        var root = (typeof self === "undefined" ? "undefined" : _typeof(self)) == 'object' && self.self === self && self || _typeof(global) == 'object' && global.global === global && global; // Set up Backbone appropriately for the environment. Start with AMD.
  ...
  5: [function (require, module, exports) {
    ...
    function (_Backbone$View) {
      ...
      function ClickableImageView() {
        ...
        return _possibleConstructorReturn(this, _getPrototypeOf(ClickableImageView).apply(this, arguments));
      }
    ...
    module.exports = ClickableImageView;
  }, {
    "backbone": 1
  }],
  6: [function (require, module, exports) {
    ...
    function (_Backbone$View2) {
      ...
      function NavbarView() {
        ...
        return _possibleConstructorReturn(this, _getPrototypeOf(NavbarView).apply(this, arguments));
      }

      _createClass(NavbarView, [{
        key: "initialize",
        value: function initialize() {
          this.mobileButton = $('.mobile-toggle');
          this.mobileMenu = $('.mobile-menu');
          this.mobileDropdowns = $('.drop-down-container');
          $(window).resize(this.resizeWindow.bind(this));
          $('.drop-down-container').click(this.toggleMobileDropdown);
        }
      }, {
        key: "events",
        value: function events() {
          return {
            'click .mobile-toggle': this.toggleMobileMenu
          };
        }
      }, {
        key: "el",
        ...
        value: function toggleMobileMenu() {
          this.mobileButton.toggleClass('open');
          this.mobileMenu.toggleClass('open');
          this.mobileDropdowns.removeClass('open');
        }
      }, {
        key: "resizeWindow",
        value: function resizeWindow() {
          this.mobileButton.removeClass('open');
          this.mobileMenu.removeClass('open');
          this.mobileDropdowns.removeClass('open');
        }
      }, {
        key: "toggleMobileDropdown",
        value: function toggleMobileDropdown(event) {
